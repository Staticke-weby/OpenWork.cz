...
„přeloženou z angličtiny" — kostrbaté vazby, divná slova. Pro práci v češtině
se proto vyplatí model, který ji zvládá přirozeně — a nejlepší test je dát mu
kus vlastního textu a posoudit, jestli zní česky.
...
- **Přirozenost.** Čtěte výstup jako rodilý mluvčí — kde to skřípe, zkuste
  jiný model.
- **Odborné termíny.** U specializovaných textů ověřte, že model používá
  správné české výrazy.
- **Delší texty.** U dlouhých textů hlídejte, jestli si model udrží styl
  a souvislost.
