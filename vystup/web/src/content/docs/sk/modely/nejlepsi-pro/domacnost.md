...
description: "Ktorý AI model sa hodí na bežné domáce použitie — lacný, rýchly a dosť chytrý na každodenné úlohy. S čím začať a kedy zvážiť lokálny model."
sidebar:
  order: 3
last_verified: 2026-08-31
---

Doma väčšinou nepotrebujete ten najchytrejší (a najdrahší) model. Hodí sa niečo
**rýchle, lacné a dosť chytré** na bežné úlohy: zhrnúť dokument, spísať e-mail,
prejsť poznámky.
